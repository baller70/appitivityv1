(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("react"), require("next/dynamic")) : typeof define === "function" && define.amd ? define(["exports", "react", "next/dynamic"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.StagewiseToolbarNext = {}, global.react, global.dynamic));
})(this, function(exports2, require$$0, dynamic) {
  ...
  const StagewiseToolbar = ({ config, enabled = process.env.NODE_ENV === "development" }) => {
    if (!enabled) {
      return null;
    }
    return /* @__PURE__ */ jsxRuntimeExports.jsx(DynamicToolbar, { config, enabled });
  };
